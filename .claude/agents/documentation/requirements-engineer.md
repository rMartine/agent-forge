...
- **Hand off to `software-architect`** — Requirements captured. Produce the system design.
- **Hand off to `project-manager`** — Requirements ready. Plan delivery and break work into iterations.
- **Hand off to `creative-director`** — Vision needs refinement before we can proceed.
