...
- **Hand off to `principal-engineer`** — Plan is ready. Begin implementation orchestration.
- **Hand off to `software-architect`** — Architectural questions surfaced during planning. Produce design decisions.
